                            ...
                            <tbody>
                                @foreach ($barangKeluar as $barang)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit{{ $barang->idkeluar }}">
                                                Edit
                                            </button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{ $barang->idkeluar }}">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
                                    
                                    <div class="modal fade" id="edit{{ $barang->idkeluar }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="{{ route('barang.keluar.update', $barang->idkeluar) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <input type="hidden" name="idkeluar" value="{{ $barang->idkeluar }}">
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" name="jumlahkeluar" required value="{{ $barang->jumlahkeluar }}" min="1">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="keterangan" class="form-label">Keterangan</label>
                                                            <input type="text" class="form-control" name="keterangan" value="{{ $barang->keterangan }}" required>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="delete{{ $barang->idkeluar }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <form method="POST" action="{{ route('barang.keluar.delete', $barang->idkeluar) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal-body">
...
<div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('barang.keluar.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    @if ($errors->any())
                        <div class="alert alert-danger">
                    ...
                    <div class="mb-3">
                        <label for="jumlahkeluar" class="form-label">Jumlah Keluar</label>
                        <input type="number" class="form-control" name="jumlahkeluar" required value="{{ old('jumlahkeluar') }}" min="1">
                    </div>
                    <button type="submit" class="btn btn-primary">Submit</button>
                </div>
            </form>
...
<script>
    ...
    form.addEventListener('submit', function (event) {
        var jumlah = form.querySelector('input[name="jumlahkeluar"]');
        var valid = true;
